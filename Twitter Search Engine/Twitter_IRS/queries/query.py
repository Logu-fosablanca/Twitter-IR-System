...
class Query:
    ...
    def retrieve_limited_set(self, query_vector, index):
        ...
        :param index: an index of terms associated to a list of document maps containing ids w/ term frequencys # term weights
    ...
    def create_document_vectors(self, query_vector, doc_list, index):
        ...
        for term in query_vector:
            ...
            i = i + 1;
        return doc_vectors  # Here doc1 to docM are those which contain atleast one queryterm among N terms, {doc1:[queryterm1: tfidfWeight, queryterm2: tfidfWeigth, ..., querytermN: tfidfWeight], doc2:[queryterm1: tfidfWeight, queryterm2: tfidfWeigth, ..., querytermN: tfidfWeight],...upto docM:[...]}
    ...
    def execute_query(self, query):
        ...
        results = self.rank_vectors(doc_freq_vectors, query_freq_vector)    # argument1 is of type dict where keys are docId and values are lists of queryterm:tfidfWeight for respective doc, argument2 is list type which have tfidf weight of query terms.
        return results
