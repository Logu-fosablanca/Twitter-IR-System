...
system = System("data/dataset.txt", "index/frequency-index.txt", "index/tf-idf-index.txt", True)
system.test_system("myRun", "data/test-run-50.xml", "data/results.txt")


# sys = System("data/dataset.txt", "index/frequency-index.txt", "index/tf-idf-index.txt", False)
# sys.test_system_with_stringQueries("myrun", "Test query", "data/results.txt" , 3, 0.7, 100)
